  ...
  return (
    <>
      <div className="bg-white shadow-md p-4  md:h-[600px]  overflow-auto  ">
        <h1 className="font-roboto text-xl  py-4 font-semibold">
          Friend requests
        </h1>
        ...
        {friendReq?.map((item) => (
          <div className="flex items-center justify-between mt-4" key={item.id}>
            ...
            <div className="flex gap-x-2">
              <button
                className="py-3 px-5 rounded-xl w-24 bg-sky-400 font-roboto text-white font-medium"
                onClick={() => handleAccept(item)}
              >
                Accept
              </button>
              <button
                className="py-3 px-5 rounded-xl w-24 bg-red-400 font-roboto text-white font-medium"
